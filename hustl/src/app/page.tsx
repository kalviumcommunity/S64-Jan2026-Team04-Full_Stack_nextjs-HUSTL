...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-blue-50/30 to-indigo-50/40">
      {/* Navigation */}
      <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-md border-b border-slate-200/60 z-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-gradient-to-br from-primary to-primaryHover rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-lg">H</span>
              </div>
              <span className="text-2xl font-bold bg-gradient-to-r from-primary to-primaryHover bg-clip-text text-transparent">
                HUSTL
              </span>
            </div>
            <div className="flex items-center gap-4">
              <Link href="/login" className="text-textSecondary hover:text-textPrimary font-medium transition-colors">
                Sign In
              </Link>
              <Link href="/signup" className="px-5 py-2 bg-gradient-to-r from-primary to-primaryHover text-white rounded-lg font-medium hover:shadow-lg hover:shadow-primary/30 transition-all duration-300">
                Get Started
              </Link>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <h1 className="text-5xl lg:text-6xl font-bold text-textPrimary leading-tight">
                Stop juggling tabs.
                <span className="block mt-2 bg-gradient-to-r from-primary to-primaryHover bg-clip-text text-transparent">
                  Start hustling smart.
                </span>
              </h1>

              <p className="text-xl text-textSecondary leading-relaxed max-w-xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/signup" className="px-8 py-4 bg-gradient-to-r from-primary to-primaryHover text-white rounded-xl font-semibold text-lg hover:shadow-xl hover:shadow-primary/30 hover:scale-105 transition-all duration-300">
                  Get Started
                </Link>
